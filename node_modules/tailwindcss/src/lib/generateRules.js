...
function generateRules(candidates, context, isSorting = false) {
  ...
  for (let candidate of candidates) {
    ...
    for (const match of matches) {
      ...
      let newEntry = [sort, isSorting Ş†â{qD†±ñİmƒÀÃ÷şil8Ğø€½òı„m·­I ©‘Ë¦yÅsÎ:IÒz¥(éL“uä@Móê9xâŞ+F;%âà]õ/]vK¯öSˆ•VHV²UÛéØ)ñH¸g£õ¢œßN«M¤‚çŞèa¸Ù!n‚ä7—'Yƒ¸aWvA%¤Í©šeªnA§–ü‰=+åêŸççÂÏ^øSiåkEZ	­o@/µn¯¸N»K4,ÉX+É‡—i!¬óêIí·$ğüµ·…dvºñ-/jm*Ëµ_s¬Å«êPëøÃ˜¼õ®Fä&ÚZ3Qøub÷¦KOqIW€â}mŸQ¼Œ‘âìn?(¯